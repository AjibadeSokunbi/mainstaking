          ...
          try {
              ...
              //
                  ...
                  try {
                      ...
                      const token0symbol = await new web3.eth.Contract(stableabi, token0).methods.symbol().call();
                      const token1symbol = await new web3.eth.Contract(stableabi, token1).methods.symbol().call();
